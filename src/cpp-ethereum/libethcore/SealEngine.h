...
////////////////////////////////////////////////////////////// // vuicash
    void setQtumSchedule(EVMSchedule _vuicashSchedule) const { vuicashSchedule = _vuicashSchedule; }

    EVMSchedule& getQtumSchedule() const { return vuicashSchedule; }
...
private:
    ...
    mutable EVMSchedule vuicashSchedule; // vuicash
