...
#include "genesis/vuicashMainNetwork.cpp"
...
#include "genesis/test/vuicashTestNetwork.cpp"
...
std::string const& dev::eth::genesisInfo(Network _n)
{
    ...
    {
    //Client genesis
    case Network::vuicashMainNetwork: return c_genesisInfoQtumMainNetwork;
    case Network::MainNetwork: return c_genesisInfoMainNetwork;
    case Network::Ropsten: return c_genesisInfoRopsten;

    //Test genesis
    case Network::vuicashTestNetwork: return c_genesisInfoQtumTestNetwork;
...
h256 const& dev::eth::genesisStateRoot(Network _n)
{
    switch (_n)
    {
    case Network::vuicashMainNetwork: return c_genesisStateRootQtumMainNetwork;
    case Network::vuicashTestNetwork: return c_genesisStateRootQtumTestNetwork;
